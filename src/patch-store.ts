...
function findEntryStart(lines: string[], id: string): number | undefined {
...
function blockEnd(lines: string[], start: number): number {
  ...
  if (startLine === undefined) return start
...
function applyDisabled(lines: string[], start: number, end: number, disabled: boolean): string[] {
  const result = [...lines]
  const startLine = lines[start]
  if (startLine === undefined) return result
 ...
 */
function appendRow(lines: string[], id: string, disabled: boolean): string[] {
  const result = [...lines]
 ...
 */
export function editEntryDisabled(content: string, id: string, disabled: boolean): string {
...
export function readPatchFile(path: string): string | undefined {
  try {
 ...
 */
export function writeEntryDisabled(path: string, id: string, disabled: boolean): string | undefined {
...
export function restorePatchFile(path: string, previous: string | undefined): void {
